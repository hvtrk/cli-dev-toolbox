"""JSON conversion utilities for CLI Dev Toolbox.

This module provides functions for converting JSON to CSV format,
pretty printing JSON, and validating JSON files.
"""
